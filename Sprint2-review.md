...
A4 - Resize avgränsas inte till skrivbordet  
A9 - Maximera finns tillgängligt för fönster som inte bör förändras i storlek, det kanske också kan vara lämpligt att kunna återställa storlek efter maximering  
C4 - Loadern i rss reader hamnar utanför fönstret  

Det har också uppkommit en del nya punkter som kommer att läggas till, enligt följande:  
D4 - Som användare vill jag att bästa resultat ska registreras globalt så att jag kan tävla mot andra  
G Anteckningar  
G1 - Som användare vill jag kunna spara anteckningar  

Strykas: A6, A7, A8, A11, C3, C5, D2, D3  
Tillägg: D4, G1  
Återaktiveras: A1, A4, A9, C4  